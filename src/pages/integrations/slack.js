...
import SlackOnTrckImage from "../../../static/images/integration/slack-ontrck.svg";
...
const AboutPage = () => (
    <Layout>
        ...
        <div className={"page-header"}>
            <img alt={"Slack"} src={SlackOnTrckImage}/>
            <h2>OnTrck and Slack</h2>
            <p>OnTrck is excited to announce a new integration with Slack<br />if you use the Slack it can be really efficient for your team.</p>
        </div>
