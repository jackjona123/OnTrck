...
const AboutPage = () => (
    <Layout>
        ...
        <div className={"page-header"}>
            <h2>What’s OnTrck?</h2>
            <p>OnTrck is a service that boost the staff’s productivity by offering new ways<br />to increase employee motivation and happiness.</p>
        </div>
                ...
                <div className={"row"}>
                    <div className={"col-6"}>
                        <div className={"item"}>
                            ...
                            <p>Having a human management software for businesses and startups is not always cost-effective. OnTrck allows companies to archive their employees' documents and information free of charge.</p>
                        </div>
                    </div>
                    ...
                    <div className={"col-6"}>
                        <div className={"item"}>
                            ...
                            <h3>Manage Events</h3>
                            <p>How to hold internal events is one of the problems of companies. OnTrck by presenting new ideas allows event management to be done as easily as possible.</p>
                        </div>
                    </div>
                </div>
